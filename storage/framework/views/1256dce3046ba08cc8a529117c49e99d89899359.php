...
<div class="card shadow mb-4">
  <div class="card-header py-3">
   <!--  <h6 class="m-0 font-weight-bold text-primary">
        <a href="/<?php echo e($orgId); ?>/jurisdiction/create" class="btn btn-primary btn-icon-split">
	...
	<!--<a href="/<?php echo e($orgId); ?>/jurisdiction/create" class="btn btn-success"> <i class="fas fa-plus"></i> <span class="text">Jurisdiction</span></a>
  -->
  ...
  <div class="card-body">
    <div class="table-responsive">
      <table class="table table-bordered table-dark" id="dataTable" width="100%" cellspacing="0">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $juris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $j): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr>
                <td><?php echo e($j->levelName); ?></td>
                <td>
                    <div class="actions">
                    <div style="float:left !important;padding-left:5px;">
                        <a class="btn btn-primary btn-circle btn-sm"  id="edit-jusrisdiction" value="<?php echo e($j->id); ?>" href=<?php echo e(route('jurisdictions.edit',$j->id)); ?>><i class="fas fa-pen"></i></a>
                        </div>
                        <div style="float:left !important;padding-left:5px;">
                        <form action="<?php echo e(url('jurisdictions', $j->id)); ?>" method="POST" id="delete-jusrisdiction-form">
                            <?php echo e(csrf_field()); ?>

                            <?php echo e(method_field('DELETE')); ?>

                            <button type="submit" class="btn btn-danger btn-circle btn-sm" id="delete-jusrisdiction" name="delJusrisButton" value="<?php echo e($j->id); ?>"><i class="fas fa-trash"></i></button>
                        </form>
                        </div>
                        <div style="float:left !important;padding-left:5px;">
                            <a class="btn btn-success btn-circle btn-sm" value="<?php echo e($j->id); ?>" href="/<?php echo e($orgId); ?>/jurisdictions/<?php echo e($j->id); ?>"><i class="fas fa-plus"></i></a>
                        </div>
